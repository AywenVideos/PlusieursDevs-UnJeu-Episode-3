...
// Decreases a light_'s intensity over time.
...
public class CFX_LightIntensityFade : MonoBehaviour
{
	...
	/// Final intensity of the light_.
	public float finalIntensity = 0.0f;
	
	// Base intensity, automatically taken from light_ parameters.
	private float baseIntensity;
	
	// If <c>true</c>, light_ will destructs itself on completion of the effect
